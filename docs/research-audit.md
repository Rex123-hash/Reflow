...
| New work | Projects must be newly created during the submission period; incorporated pre-existing work must be disclosed. | Independent code, prompts, tests, docs, and Git history; maintain `PREEXISTING_WORK_DISCLOSURE.md`. |
