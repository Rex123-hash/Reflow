...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=objective-recovery,service.version={commit_sha}",
        )
    ...
    if not project_id:
        raise RuntimeError("Google Cloud project is required for telemetry")
    ...
    _setup_instrumentation_lib_if_installed()  # type: ignore[no-untyped-call]
