...
export type CalendarEventCreation = {
  ...
  reminders?: CalendarReminderConfiguration;
  start: string;
  summary: string;
  time_basis: "ABSOLUTE" | "RELATIVE";
  timezone: string;
};
export type CalendarReminder = { method: "popup" | "email"; minutes: number };
export type CalendarReminderConfiguration = {
...
export type RequestedOperation = {
  calendar_event?: CalendarEventCreation | null;
  comment?: string | null;
  operation:
    | "JIRA_TRANSITION"
    | "JIRA_SET_PRIORITY"
