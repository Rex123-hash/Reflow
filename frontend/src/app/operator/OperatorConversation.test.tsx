  ...
  it("renders HELP as a natural direct answer without inventing an operational intent", async () => {
    const help = {
      ...
      conversation: {
        ...
        context_source: "NONE",
        ambiguity_flag: false,
        candidate_interpretations: ["Explain Reflow's capabilities."],
        clarification_required: false,
        scope_resolution: "EXACT",
        direct_response:
    ...
    const clarify = {
      ...
      conversation: {
        ...
        candidate_interpretations: [
          "Inspect a recovery.",
          "Inspect a configured provider resource.",
        ],
